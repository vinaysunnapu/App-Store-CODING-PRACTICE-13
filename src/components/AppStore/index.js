        ...
        <ul className="tab-container">
          {tabsList.map(eachList => (
            <TabItem
              ...
              isActive={eachList.tabId === activeTabId}
            />
          ))}
        </ul>
        <ul className="apps-container">
          {filteredApps.map(eachAppList => (
            <AppItem appItem={eachAppList} key={eachAppList.appId} />
          ))}
        </ul>
      </div>
    )
